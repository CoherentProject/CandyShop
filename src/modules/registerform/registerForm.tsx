...
const RegisterForm = () => {
  ...
  // } 
      ...
      function createDoc(username: string,password: string){
        // alert(username+email+password)
        ref.doc().set({username,password}).catch((err) => {
          alert(err)
          console.error(err);
        })
  ...
  return (
    ...
    <form>
        ...
        <button className="register"> <Link className="linkbuton"to="/loginPage"> Ai deja cont?Apasa aici</Link></button>
        <button className="register"> <Link className="linkbuton"to="/startingPage"> Intoarce-te la pagina principala</Link></button>
      </form></>
  );
};
